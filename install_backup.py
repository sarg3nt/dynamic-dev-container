...
from installer.screens_extension_selection import ExtensionSelectionScreen

# Import screen classes
from installer.screens_navigation import NavigationScreenBase
from installer.screens_project_config import ProjectConfigScreen
from installer.screens_tool_selection_actions import ToolSelectionActionMixin
from installer.screens_tool_selection_config import ToolSelectionConfigMixin
from installer.screens_tool_selection_core import ToolSelectionScreenCore
from installer.screens_tool_selection_events import ToolSelectionEventMixin
from installer.screens_tool_selection_urls import ToolSelectionUrlMixin
from installer.screens_tool_version import ToolVersionScreen
...
class ToolSelectionScreen(
    ToolSelectionScreenCore,
    ToolSelectionConfigMixin,
    ToolSelectionEventMixin,
    ToolSelectionUrlMixin,
    ToolSelectionActionMixin,
):
    """Screen for selecting development tools.
    
    This screen combines functionality from multiple mixins to provide:
    - Core UI composition and loading management (ToolSelectionScreenCore)
    - Configuration management and Python forms (ToolSelectionConfigMixin)
    - Event handling for user interactions (ToolSelectionEventMixin)
    - URL generation and package field management (ToolSelectionUrlMixin)
    - Action methods and navigation (ToolSelectionActionMixin)
    """

    # All functionality is provided by the mixin classes
