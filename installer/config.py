"""Configuration classes for the Dynamic Dev Container installer.

This module contains the ProjectConfig class and related configuration
data structures used throughout the installer application.
"""
